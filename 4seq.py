...
while True:
   ...
   'paster' : '27.12.1822',
    ...
    procent_right = right * 100 / 10
    procent_mistake = mistakes * 100 / 10
    print('Процент правильных ответов:', procent_right)
    print('Процент неправильных ответов:', procent_mistake)
